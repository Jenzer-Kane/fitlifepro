            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="team_member_box_content">
                    ...
                    <div class="team_member_box_lower_portion">
                        ...
                        <p>  Experience and expertise as a physical therapy specialist. With a 5-year track record in the field, he has successfully treated a diverse range of patients, demonstrating a deep understanding of rehabilitation and therapeutic techniques. </p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="team_member_box_content">
                    ...
                    <div class="team_member_box_lower_portion">
                        ...
                        <p>Highly qualified hospital nurse with specialized knowledge in kinesthetics and nutrition. Her educational background and practical experience abroad equip her to address holistic health concerns in clinical and community practice.</p>
                        <div class="team_member_social_icons">
                            <a href="#" class="text-decoration-none">
                                <i class="fa-brands fa-facebook-f" aria-hidden="true"></i>
                            </a>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="team_member_box_content">
                    ...
                    <div class="team_member_box_lower_portion">
                        ...
                        <p>Men’s Classic Physique Athlete having a background in bodybuilding competitions, offering knowledge and guidance in lifestyle, weight management, bodybuilding, strength and conditioning. </p>
                        <div class="team_member_social_icons">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="team_member_box_content">
                    ...
                    <div class="team_member_box_lower_portion">
                        ...
                        <div class="team_member_social_icons">
                            <a href="https://www.facebook.com/aaronjulius.geronimo" class="text-decoration-none">
                                <i class="fa-brands fa-facebook-f" aria-hidden="true"></i>
                            </a>
