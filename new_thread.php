...
<!DOCTYPE html>
<html lang="en">
<!-- HTML content as provided in your initial code remains the same -->
...
<head>
    <meta charset="UTF-8">
    <title>Create New Thread | FITLIFE PRO</title>
    <!-- /SEO Ultimate -->
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="banner-section-content">
                            <h1 data-aos="fade-up">New Thread</h1>
                            <div class="btn_wrapper">
                                <span class="sub_home_span">Exercises </span>-<span class="sub_span">New Thread</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <h3 class="mt-5">Create New Thread in <h2><?= htmlspecialchars($forum['name']) ?></h2>
        </h3>
